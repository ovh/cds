...
import {ApplicationPollerFormComponent} from './application.poller.form.component';
...
describe('CDS: Application poller form component', () => {
    ...
    it('should add a new poller', fakeAsync( () => {
        let call = 0;


        // Create Project RepoManager Form Component
        let fixture = TestBed.createComponent(ApplicationPollerFormComponent);
        ...
        compiled.querySelector('button[name="addpollerbtn"]').click();
...
class MockAppStore {
   addPoller(k: string, a: string, p: string, pl: RepositoryPoller) {
