...
Designed for scalability, CDS tasks can run either on cloud infrastructure or on your own machines, should you start some workers using a [hatchery]({{< relref "/manual/components/hatchery/_index.md" >}}).

CDS exposes an API available to [workers]({{< relref "/manual/components/worker/_index.md" >}}) and humans through CLI or WebUI.
