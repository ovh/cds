...
And a requirement model which allow you to execute `apt-get install -y postgresql-client`, see [HowTo]({{< relref "/manual/getting_started/tutorials/worker_model-docker/_index.md" >}})
