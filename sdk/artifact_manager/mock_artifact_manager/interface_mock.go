...
func (m *MockArtifactManager) SearchItems(ctx context.Context, locations []sdk.ArtifactLocation, propertyKey string) (sdk.ArtifactResults, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SearchItems", ctx, locations, propertyKey)
	ret0, _ := ret[0].(sdk.ArtifactResults)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockArtifactManagerMockRecorder) SearchItems(ctx, locations, propertyKey any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SearchItems", reflect.TypeOf((*MockArtifactManager)(nil).SearchItems), ctx, locations, propertyKey)
}
