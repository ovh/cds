...
type V2WorkerModel struct {
	...
	From        string          `json:"from" jsonschema_extras:"order=3,disable=true"`
...
type V2WorkerModelDockerSpec struct {
	...
	Username string            `json:"username,omitempty" jsonschema_extras:"order=3,position=left"`
	Password string            `json:"password,omitempty" jsonschema_extras:"order=3,position=right"`
	Cmd      string            `json:"cmd,omitempty" jsonschema:"required,minLength=1" jsonschema_extras:"order=5"`
	Shell    string            `json:"shell,omitempty" jsonschema:"required,minLength=1" jsonschema_extras:"order=4"`
	Envs     map[string]string `json:"envs,omitempty" jsonschema_extras:"order=6"`
}
