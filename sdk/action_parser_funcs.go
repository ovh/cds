...
func dfault(_ context.Context, a *ActionParser, inputs ...interface{}) (interface{}, error) {
	...
	case 1:
		return inputs[0], nil // "var" | default OR default "var"
	case 2:
		// second arg is the first input value since in case of | (pipe) it's added as last argument
		if empty(inputs[1]) {
			return inputs[0], nil // "var" | default "" OR default "" "var" => will return "var"
		}
		return inputs[1], nil // "" | default "var" OR default "var" "" => will return "var"
	default:
