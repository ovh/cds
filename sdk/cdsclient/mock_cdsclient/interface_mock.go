...
func (m *MockQueueClient) QueuePolling(ctx context.Context, goRoutines *sdk.GoRoutines, hatcheryMetrics *sdk.HatcheryMetrics, pendingWorkerCreation *sdk.HatcheryPendingWorkerCreation, jobs chan<- sdk.WorkflowNodeJobRun, errs chan<- error, delay time.Duration, ms ...cdsclient.RequestModifier) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, goRoutines, hatcheryMetrics, pendingWorkerCreation, jobs, errs, delay}
	for _, a := range ms {
		varargs = append(varargs, a)
	}
...
func (mr *MockQueueClientMockRecorder) QueuePolling(ctx, goRoutines, hatcheryMetrics, pendingWorkerCreation, jobs, errs, delay interface{}, ms ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, goRoutines, hatcheryMetrics, pendingWorkerCreation, jobs, errs, delay}, ms...)
...
// QueuePolling mocks base method.
func (m *MockInterface) QueuePolling(ctx context.Context, goRoutines *sdk.GoRoutines, hatcheryMetrics *sdk.HatcheryMetrics, pendingWorkerCreation *sdk.HatcheryPendingWorkerCreation, jobs chan<- sdk.WorkflowNodeJobRun, errs chan<- error, delay time.Duration, ms ...cdsclient.RequestModifier) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, goRoutines, hatcheryMetrics, pendingWorkerCreation, jobs, errs, delay}
	for _, a := range ms {
		varargs = append(varargs, a)
...
// QueuePolling indicates an expected call of QueuePolling.
func (mr *MockInterfaceMockRecorder) QueuePolling(ctx, goRoutines, hatcheryMetrics, pendingWorkerCreation, jobs, errs, delay interface{}, ms ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, goRoutines, hatcheryMetrics, pendingWorkerCreation, jobs, errs, delay}, ms...)
...
// QueuePolling mocks base method.
func (m *MockWorkerInterface) QueuePolling(ctx context.Context, goRoutines *sdk.GoRoutines, hatcheryMetrics *sdk.HatcheryMetrics, pendingWorkerCreation *sdk.HatcheryPendingWorkerCreation, jobs chan<- sdk.WorkflowNodeJobRun, errs chan<- error, delay time.Duration, ms ...cdsclient.RequestModifier) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, goRoutines, hatcheryMetrics, pendingWorkerCreation, jobs, errs, delay}
	for _, a := range ms {
		varargs = append(varargs, a)
...
// QueuePolling indicates an expected call of QueuePolling.
func (mr *MockWorkerInterfaceMockRecorder) QueuePolling(ctx, goRoutines, hatcheryMetrics, pendingWorkerCreation, jobs, errs, delay interface{}, ms ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, goRoutines, hatcheryMetrics, pendingWorkerCreation, jobs, errs, delay}, ms...)
