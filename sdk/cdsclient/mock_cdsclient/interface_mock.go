...
func (m *MockActionClient) ActionImport(content io.Reader) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ActionImport", content)
	ret0, _ := ret[0].(error)
	return ret0
}

// ActionImport indicates an expected call of ActionImport
func (mr *MockActionClientMockRecorder) ActionImport(content interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ActionImport", reflect.TypeOf((*MockActionClient)(nil).ActionImport), content)
}
...
// ActionImport mocks base method
func (m *MockInterface) ActionImport(content io.Reader) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ActionImport", content)
	ret0, _ := ret[0].(error)
	return ret0
...
// ActionImport indicates an expected call of ActionImport
func (mr *MockInterfaceMockRecorder) ActionImport(content interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ActionImport", reflect.TypeOf((*MockInterface)(nil).ActionImport), content)
}
