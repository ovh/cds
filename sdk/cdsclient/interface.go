...
type WorkflowV2Client interface {
	...
	WorkflowV2ReRun(ctx context.Context, projectKey, vcsIdentifier, repoIdentifier, wkfName string, runNumber int64, mods ...RequestModifier) (*sdk.V2WorkflowRun, error)
