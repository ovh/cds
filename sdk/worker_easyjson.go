		...
		case "registered_capabilities":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.RegisteredCapabilities = append(out.RegisteredCapabilities, v6)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson82a45abeEncodeGithubComOvhCdsSdk9(out *jwriter.Writer, in Model) {
	...
	}
	{
		...
		if in.RegisteredCapabilities == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v7, v8 := range in.RegisteredCapabilities {
				if v7 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "admins":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v9 User
					easyjson82a45abeDecodeGithubComOvhCdsSdk10(in, &v9)
		...
		case "tokens":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v11 Token
					easyjson82a45abeDecodeGithubComOvhCdsSdk12(in, &v11)
					out.Tokens = append(out.Tokens, v11)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson82a45abeEncodeGithubComOvhCdsSdk11(out *jwriter.Writer, in Group) {
	...
	if len(in.Tokens) != 0 {
		...
		{
			out.RawByte('[')
			for v16, v17 := range in.Tokens {
				if v16 > 0 {
					out.RawByte(',')
				}
				easyjson82a45abeEncodeGithubComOvhCdsSdk12(out, v17)
			}
			out.RawByte(']')
		}
	}
	...
	for !in.IsDelim('}') {
		...
		case "groups":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v18 Group
					easyjson82a45abeDecodeGithubComOvhCdsSdk11(in, &v18)
					out.Groups = append(out.Groups, v18)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "favorites":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v19 Favorite
					easyjson82a45abeDecodeGithubComOvhCdsSdk13(in, &v19)
					out.Favorites = append(out.Favorites, v19)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson82a45abeEncodeGithubComOvhCdsSdk10(out *jwriter.Writer, in User) {
	...
	if len(in.Groups) != 0 {
		...
		}
		{
			...
			for v20, v21 := range in.Groups {
				...
				easyjson82a45abeEncodeGithubComOvhCdsSdk11(out, v21)
			}
			out.RawByte(']')
		}
	}
	...
	}
	{
		...
		if in.Favorites == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v22, v23 := range in.Favorites {
				if v22 > 0 {
					out.RawByte(',')
				}
				easyjson82a45abeEncodeGithubComOvhCdsSdk13(out, v23)
			}
			out.RawByte(']')
		}
	}
		...
		case "project_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v24 int64
					v24 = int64(in.Int64())
					out.ProjectIDs = append(out.ProjectIDs, v24)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "workflow_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v25 int64
					v25 = int64(in.Int64())
					out.WorkflowIDs = append(out.WorkflowIDs, v25)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson82a45abeEncodeGithubComOvhCdsSdk13(out *jwriter.Writer, in Favorite) {
	...
	_ = first
	{
		...
		if in.ProjectIDs == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v26, v27 := range in.ProjectIDs {
				if v26 > 0 {
					out.RawByte(',')
				}
				out.Int64(int64(v27))
	...
	}
	{
		...
		if in.WorkflowIDs == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v28, v29 := range in.WorkflowIDs {
				if v28 > 0 {
					out.RawByte(',')
				}
				out.Int64(int64(v29))
