...
type Application struct {
	...
	RepositoryStrategy RepositoryStrategy    `json:"vcs_strategy,omitempty" db:"-" dbjson:"vcs_strategy"`
	...
	Metadata           Metadata              `json:"metadata" yaml:"metadata" db:"-" dbjson:"metadata"`
