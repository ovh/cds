...
type GitContext struct {
	...
	ServerType             string   `json:"server_type,omitempty" jsonschema:"example=gitea" jsonschema_description:"VCS server type (github, gitlab, bitbucketserver, bitbucketcloud, gitea, forgejo)"`
