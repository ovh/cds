	...
	for !in.IsDelim('}') {
		...
		case "group":
			if in.IsNull() {
				...
				easyjson1c3bd83cDecodeGithubComOvhCdsSdk3(in, out.Group)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjson1c3bd83cEncodeGithubComOvhCdsSdk(out *jwriter.Writer, in Model) {
	...
	}
	{
		...
		if in.Group == nil {
			...
			easyjson1c3bd83cEncodeGithubComOvhCdsSdk3(out, *in.Group)
		}
	}
	out.RawByte('}')
}
...
func easyjson1c3bd83cDecodeGithubComOvhCdsSdk3(in *jlexer.Lexer, out *Group) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "tokens":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v6 Token
					easyjson1c3bd83cDecodeGithubComOvhCdsSdk4(in, &v6)
...
func easyjson1c3bd83cEncodeGithubComOvhCdsSdk3(out *jwriter.Writer, in Group) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	if len(in.Tokens) != 0 {
		...
		}
		{
			...
			for v11, v12 := range in.Tokens {
				...
				easyjson1c3bd83cEncodeGithubComOvhCdsSdk4(out, v12)
			}
			out.RawByte(']')
		}
	}
...
func easyjson1c3bd83cDecodeGithubComOvhCdsSdk4(in *jlexer.Lexer, out *Token) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson1c3bd83cEncodeGithubComOvhCdsSdk4(out *jwriter.Writer, in Token) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson1c3bd83cEncodeGithubComOvhCdsSdk2(out *jwriter.Writer, in ModelDocker) {
	...
	if len(in.Envs) != 0 {
		...
		}
		{
			out.RawByte('{')
			v14First := true
			for v14Name, v14Value := range in.Envs {
				if v14First {
					v14First = false
				} else {
					out.RawByte(',')
