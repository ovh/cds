		...
		case "favorites":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Favorites = append(out.Favorites, v14)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson1c3bd83cEncodeGithubComOvhCdsSdk3(out *jwriter.Writer, in User) {
	...
	if len(in.Groups) != 0 {
		...
		}
		{
			...
			for v15, v16 := range in.Groups {
				...
				easyjson1c3bd83cEncodeGithubComOvhCdsSdk4(out, v16)
			}
			out.RawByte(']')
		}
	}
	...
	}
	{
		...
		if in.Favorites == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v17, v18 := range in.Favorites {
				if v17 > 0 {
					out.RawByte(',')
				}
				easyjson1c3bd83cEncodeGithubComOvhCdsSdk6(out, v18)
			}
			out.RawByte(']')
		}
	}
...
func easyjson1c3bd83cDecodeGithubComOvhCdsSdk6(in *jlexer.Lexer, out *Favorite) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "project_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v19 int64
					v19 = int64(in.Int64())
					out.ProjectIDs = append(out.ProjectIDs, v19)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "workflow_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v20 int64
					v20 = int64(in.Int64())
					out.WorkflowIDs = append(out.WorkflowIDs, v20)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson1c3bd83cEncodeGithubComOvhCdsSdk6(out *jwriter.Writer, in Favorite) {
	out.RawByte('{')
	first := true
	_ = first
	{
		...
		if in.ProjectIDs == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v21, v22 := range in.ProjectIDs {
				if v21 > 0 {
					out.RawByte(',')
				}
				out.Int64(int64(v22))
	...
	}
	{
		...
		if in.WorkflowIDs == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v23, v24 := range in.WorkflowIDs {
				if v23 > 0 {
					out.RawByte(',')
				}
				out.Int64(int64(v24))
...
func easyjson1c3bd83cEncodeGithubComOvhCdsSdk2(out *jwriter.Writer, in ModelDocker) {
	...
	if len(in.Envs) != 0 {
		...
		}
		{
			out.RawByte('{')
			v26First := true
			for v26Name, v26Value := range in.Envs {
				if v26First {
					v26First = false
				} else {
					out.RawByte(',')
