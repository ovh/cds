	...
	for !in.IsDelim('}') {
		...
		case "members":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v4 GroupMember
					easyjson1c3bd83cDecodeGithubComOvhCdsSdk5(in, &v4)
	...
	if len(in.Members) != 0 {
		...
		}
		{
			...
			for v5, v6 := range in.Members {
				...
				easyjson1c3bd83cEncodeGithubComOvhCdsSdk5(out, v6)
			}
			out.RawByte(']')
		}
	}
...
func easyjson1c3bd83cDecodeGithubComOvhCdsSdk5(in *jlexer.Lexer, out *GroupMember) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson1c3bd83cEncodeGithubComOvhCdsSdk5(out *jwriter.Writer, in GroupMember) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	for !in.IsDelim('}') {
		...
		case "groups":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v7 Group
					easyjson1c3bd83cDecodeGithubComOvhCdsSdk4(in, &v7)
		...
		case "favorites":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v8 Favorite
					easyjson1c3bd83cDecodeGithubComOvhCdsSdk6(in, &v8)
					out.Favorites = append(out.Favorites, v8)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson1c3bd83cEncodeGithubComOvhCdsSdk3(out *jwriter.Writer, in User) {
	...
	if len(in.Groups) != 0 {
		...
		}
		{
			...
			for v9, v10 := range in.Groups {
				...
				easyjson1c3bd83cEncodeGithubComOvhCdsSdk4(out, v10)
			}
			out.RawByte(']')
		}
	}
	...
	}
	{
		...
		if in.Favorites == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v11, v12 := range in.Favorites {
				if v11 > 0 {
					out.RawByte(',')
				}
				easyjson1c3bd83cEncodeGithubComOvhCdsSdk6(out, v12)
			}
			out.RawByte(']')
		}
	}
	...
	if in.GroupAdmin {
		const prefix string = ",\"group_admin\":"
		if first {
			first = false
			out.RawString(prefix[1:])
		} else {
		...
		case "project_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v13 int64
					v13 = int64(in.Int64())
					out.ProjectIDs = append(out.ProjectIDs, v13)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "workflow_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v14 int64
					v14 = int64(in.Int64())
					out.WorkflowIDs = append(out.WorkflowIDs, v14)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson1c3bd83cEncodeGithubComOvhCdsSdk6(out *jwriter.Writer, in Favorite) {
	...
	_ = first
	{
		...
		if in.ProjectIDs == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v15, v16 := range in.ProjectIDs {
				if v15 > 0 {
					out.RawByte(',')
				}
				out.Int64(int64(v16))
	...
	}
	{
		...
		if in.WorkflowIDs == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v17, v18 := range in.WorkflowIDs {
				if v17 > 0 {
					out.RawByte(',')
				}
				out.Int64(int64(v18))
...
func easyjson1c3bd83cEncodeGithubComOvhCdsSdk2(out *jwriter.Writer, in ModelDocker) {
	...
	if len(in.Envs) != 0 {
		...
		}
		{
			out.RawByte('{')
			v20First := true
			for v20Name, v20Value := range in.Envs {
				if v20First {
					v20First = false
				} else {
					out.RawByte(',')
