...
var errorsAmericanEnglish = map[int]string{
	...
	ErrAlreadyLatestTemplate.ID:                  "The template version used is already the latest",
}
...
var errorsFrench = map[int]string{
	...
	ErrAlreadyLatestTemplate.ID:                  "La version du template utilisé est déjà la plus récente",
}
