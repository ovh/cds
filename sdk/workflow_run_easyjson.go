		...
		case "favorites":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Favorites = append(out.Favorites, v40)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonD7860c2dEncodeGithubComOvhCdsSdk7(out *jwriter.Writer, in User) {
	...
	if len(in.Groups) != 0 {
		...
		{
			out.RawByte('[')
			for v41, v42 := range in.Groups {
				if v41 > 0 {
					out.RawByte(',')
				}
				easyjsonD7860c2dEncodeGithubComOvhCdsSdk5(out, v42)
			}
			out.RawByte(']')
		}
	}
	...
	}
	{
		...
		if in.Favorites == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v43, v44 := range in.Favorites {
				if v43 > 0 {
					out.RawByte(',')
				}
				easyjsonD7860c2dEncodeGithubComOvhCdsSdk9(out, v44)
			}
			out.RawByte(']')
		}
	}
		...
		case "project_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v45 int64
					v45 = int64(in.Int64())
					out.ProjectIDs = append(out.ProjectIDs, v45)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "workflow_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v46 int64
					v46 = int64(in.Int64())
					out.WorkflowIDs = append(out.WorkflowIDs, v46)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonD7860c2dEncodeGithubComOvhCdsSdk9(out *jwriter.Writer, in Favorite) {
	...
	_ = first
	{
		...
		if in.ProjectIDs == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v47, v48 := range in.ProjectIDs {
				if v47 > 0 {
					out.RawByte(',')
				}
				out.Int64(int64(v48))
	...
	}
	{
		...
		if in.WorkflowIDs == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v49, v50 := range in.WorkflowIDs {
				if v49 > 0 {
					out.RawByte(',')
				}
				out.Int64(int64(v50))
...
func easyjsonD7860c2dDecodeGithubComOvhCdsSdk3(in *jlexer.Lexer, out *Service) {
	...
	for !in.IsDelim('}') {
		...
		case "config":
			if m, ok := out.Config.(easyjson.Unmarshaler); ok {
				m.UnmarshalEasyJSON(in)
			} else if m, ok := out.Config.(json.Unmarshaler); ok {
				_ = m.UnmarshalJSON(in.Raw())
			} else {
				out.Config = in.Interface()
			}
...
func easyjsonD7860c2dEncodeGithubComOvhCdsSdk3(out *jwriter.Writer, in Service) {
	...
	}
	{
		...
		easyjsonD7860c2dEncodeGithubComOvhCdsSdk11(out, in.MonitoringStatus)
	}
	{
		...
		if m, ok := in.Config.(easyjson.Marshaler); ok {
			m.MarshalEasyJSON(out)
		} else if m, ok := in.Config.(json.Marshaler); ok {
			out.Raw(m.MarshalJSON())
		} else {
			out.Raw(json.Marshal(in.Config))
		}
	}
	{
...
func easyjsonD7860c2dDecodeGithubComOvhCdsSdk11(in *jlexer.Lexer, out *MonitoringStatus) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "lines":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v54 MonitoringStatusLine
					easyjsonD7860c2dDecodeGithubComOvhCdsSdk12(in, &v54)
					out.Lines = append(out.Lines, v54)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonD7860c2dEncodeGithubComOvhCdsSdk11(out *jwriter.Writer, in MonitoringStatus) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.Lines == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v55, v56 := range in.Lines {
				if v55 > 0 {
					out.RawByte(',')
				}
				easyjsonD7860c2dEncodeGithubComOvhCdsSdk12(out, v56)
			}
			out.RawByte(']')
		}
	}
...
func easyjsonD7860c2dDecodeGithubComOvhCdsSdk12(in *jlexer.Lexer, out *MonitoringStatusLine) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonD7860c2dEncodeGithubComOvhCdsSdk12(out *jwriter.Writer, in MonitoringStatusLine) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	for !in.IsDelim('}') {
		...
		case "step_status":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v57 StepStatus
					easyjsonD7860c2dDecodeGithubComOvhCdsSdk13(in, &v57)
					out.StepStatus = append(out.StepStatus, v57)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "action":
			easyjsonD7860c2dDecodeGithubComOvhCdsSdk14(in, &out.Action)
		case "warnings":
			if in.IsNull() {
				in.Skip()
				out.Warnings = nil
				...
				for !in.IsDelim(']') {
					var v58 PipelineBuildWarning
					easyjsonD7860c2dDecodeGithubComOvhCdsSdk15(in, &v58)
					out.Warnings = append(out.Warnings, v58)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonD7860c2dEncodeGithubComOvhCdsSdk1(out *jwriter.Writer, in ExecutedJob) {
	...
	_ = first
	{
		...
		if in.StepStatus == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v59, v60 := range in.StepStatus {
				if v59 > 0 {
					out.RawByte(',')
				}
				easyjsonD7860c2dEncodeGithubComOvhCdsSdk13(out, v60)
			}
			out.RawByte(']')
		}
	}
	...
	}
	{
		...
		easyjsonD7860c2dEncodeGithubComOvhCdsSdk14(out, in.Action)
	}
	{
		...
		if in.Warnings == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v61, v62 := range in.Warnings {
				...
				easyjsonD7860c2dEncodeGithubComOvhCdsSdk15(out, v62)
			}
			out.RawByte(']')
		}
	}
...
func easyjsonD7860c2dDecodeGithubComOvhCdsSdk15(in *jlexer.Lexer, out *PipelineBuildWarning) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonD7860c2dEncodeGithubComOvhCdsSdk15(out *jwriter.Writer, in PipelineBuildWarning) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonD7860c2dDecodeGithubComOvhCdsSdk14(in *jlexer.Lexer, out *Action) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "requirements":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Requirements = append(out.Requirements, v63)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "parameters":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v64 Parameter
					easyjsonD7860c2dDecodeGithubComOvhCdsSdk2(in, &v64)
					out.Parameters = append(out.Parameters, v64)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "actions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v65 Action
					easyjsonD7860c2dDecodeGithubComOvhCdsSdk14(in, &v65)
					out.Actions = append(out.Actions, v65)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "first_audit":
			if in.IsNull() {
				...
				easyjsonD7860c2dDecodeGithubComOvhCdsSdk16(in, &*out.FirstAudit)
			}
		case "last_audit":
			if in.IsNull() {
				in.Skip()
				...
				easyjsonD7860c2dDecodeGithubComOvhCdsSdk16(in, &*out.LastAudit)
			}
		case "editable":
...
func easyjsonD7860c2dEncodeGithubComOvhCdsSdk14(out *jwriter.Writer, in Action) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.Requirements == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v66, v67 := range in.Requirements {
				if v66 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.Parameters == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v68, v69 := range in.Parameters {
				if v68 > 0 {
					out.RawByte(',')
				}
				easyjsonD7860c2dEncodeGithubComOvhCdsSdk2(out, v69)
			}
			out.RawByte(']')
		}
	}
	if len(in.Actions) != 0 {
		...
		{
			out.RawByte('[')
			for v70, v71 := range in.Actions {
				if v70 > 0 {
					out.RawByte(',')
				}
				easyjsonD7860c2dEncodeGithubComOvhCdsSdk14(out, v71)
			}
			out.RawByte(']')
		}
	}
	...
	if in.FirstAudit != nil {
		...
		easyjsonD7860c2dEncodeGithubComOvhCdsSdk16(out, *in.FirstAudit)
	}
	if in.LastAudit != nil {
		...
		easyjsonD7860c2dEncodeGithubComOvhCdsSdk16(out, *in.LastAudit)
	}
	if in.Editable {
...
func easyjsonD7860c2dEncodeGithubComOvhCdsSdk16(out *jwriter.Writer, in AuditAction) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonD7860c2dDecodeGithubComOvhCdsSdk13(in *jlexer.Lexer, out *StepStatus) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonD7860c2dEncodeGithubComOvhCdsSdk13(out *jwriter.Writer, in StepStatus) {
	out.RawByte('{')
	first := true
	_ = first
	{
