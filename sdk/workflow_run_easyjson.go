	...
	for !in.IsDelim('}') {
		...
		case "step_status":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v51 StepStatus
					easyjsonD7860c2dDecodeGithubComOvhCdsSdk11(in, &v51)
					out.StepStatus = append(out.StepStatus, v51)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "warnings":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v52 PipelineBuildWarning
					easyjsonD7860c2dDecodeGithubComOvhCdsSdk13(in, &v52)
					out.Warnings = append(out.Warnings, v52)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonD7860c2dEncodeGithubComOvhCdsSdk1(out *jwriter.Writer, in ExecutedJob) {
	...
	_ = first
	{
		...
		if in.StepStatus == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v53, v54 := range in.StepStatus {
				if v53 > 0 {
					out.RawByte(',')
				}
				easyjsonD7860c2dEncodeGithubComOvhCdsSdk11(out, v54)
			}
			out.RawByte(']')
		}
	}
	...
	}
	{
		...
		if in.Warnings == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v55, v56 := range in.Warnings {
				if v55 > 0 {
					out.RawByte(',')
				}
				easyjsonD7860c2dEncodeGithubComOvhCdsSdk13(out, v56)
			}
			out.RawByte(']')
		}
	}
	...
	for !in.IsDelim('}') {
		...
		case "requirements":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Requirements = append(out.Requirements, v57)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "parameters":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v58 Parameter
					easyjsonD7860c2dDecodeGithubComOvhCdsSdk2(in, &v58)
					out.Parameters = append(out.Parameters, v58)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "actions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v59 Action
					easyjsonD7860c2dDecodeGithubComOvhCdsSdk12(in, &v59)
					out.Actions = append(out.Actions, v59)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonD7860c2dEncodeGithubComOvhCdsSdk12(out *jwriter.Writer, in Action) {
	...
	}
	{
		...
		if in.Requirements == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v60, v61 := range in.Requirements {
				if v60 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.Parameters == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v62, v63 := range in.Parameters {
				if v62 > 0 {
					out.RawByte(',')
				}
				easyjsonD7860c2dEncodeGithubComOvhCdsSdk2(out, v63)
			}
			out.RawByte(']')
		}
	}
	{
		...
		if in.Actions == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v64, v65 := range in.Actions {
				if v64 > 0 {
					out.RawByte(',')
				}
				easyjsonD7860c2dEncodeGithubComOvhCdsSdk12(out, v65)
			}
			out.RawByte(']')
		}
	}
