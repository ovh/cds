	...
	for !in.IsDelim('}') {
		...
		case "lines":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v53 MonitoringStatusLine
					easyjsonD7860c2dDecodeGithubComOvhCdsSdk12(in, &v53)
					out.Lines = append(out.Lines, v53)
					in.WantComma()
				}
				in.Delim(']')
			}
	...
	for !in.IsDelim('}') {
		...
		case "step_status":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v56 StepStatus
					easyjsonD7860c2dDecodeGithubComOvhCdsSdk13(in, &v56)
					out.StepStatus = append(out.StepStatus, v56)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "warnings":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjsonD7860c2dDecodeGithubComOvhCdsSdk15(in, &v57)
...
func easyjsonD7860c2dEncodeGithubComOvhCdsSdk1(out *jwriter.Writer, in ExecutedJob) {
	...
	_ = first
	{
		...
		if in.StepStatus == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v58, v59 := range in.StepStatus {
				if v58 > 0 {
					out.RawByte(',')
				}
				easyjsonD7860c2dEncodeGithubComOvhCdsSdk13(out, v59)
			}
			out.RawByte(']')
		}
	}
	...
	}
	{
		...
		if in.Warnings == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v60, v61 := range in.Warnings {
				if v60 > 0 {
					out.RawByte(',')
				}
				easyjsonD7860c2dEncodeGithubComOvhCdsSdk15(out, v61)
			}
			out.RawByte(']')
		}
	}
	...
	for !in.IsDelim('}') {
		...
		case "requirements":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Requirements = append(out.Requirements, v62)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "parameters":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v63 Parameter
					easyjsonD7860c2dDecodeGithubComOvhCdsSdk2(in, &v63)
					out.Parameters = append(out.Parameters, v63)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "actions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v64 Action
					easyjsonD7860c2dDecodeGithubComOvhCdsSdk14(in, &v64)
...
func easyjsonD7860c2dEncodeGithubComOvhCdsSdk14(out *jwriter.Writer, in Action) {
	...
	}
	{
		...
		if in.Requirements == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v65, v66 := range in.Requirements {
				if v65 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.Parameters == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v67, v68 := range in.Parameters {
				if v67 > 0 {
					out.RawByte(',')
				}
				easyjsonD7860c2dEncodeGithubComOvhCdsSdk2(out, v68)
			}
			out.RawByte(']')
		}
	}
	if len(in.Actions) != 0 {
		...
		}
		{
			...
			for v69, v70 := range in.Actions {
				...
				easyjsonD7860c2dEncodeGithubComOvhCdsSdk14(out, v70)
			}
			out.RawByte(']')
		}
	}
