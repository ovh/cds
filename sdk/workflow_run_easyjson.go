		...
		case "requirements":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Requirements = append(out.Requirements, v19)
					in.WantComma()
				}
				in.Delim(']')
			}
	...
	for !in.IsDelim('}') {
		...
		case "admins":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Admins = append(out.Admins, v27)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "users":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v28 User
					easyjsonD7860c2dDecodeGithubComOvhCdsSdk7(in, &v28)
		...
		case "tokens":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v29 Token
					easyjsonD7860c2dDecodeGithubComOvhCdsSdk8(in, &v29)
					out.Tokens = append(out.Tokens, v29)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonD7860c2dEncodeGithubComOvhCdsSdk5(out *jwriter.Writer, in Group) {
	...
	if len(in.Users) != 0 {
		...
		{
			out.RawByte('[')
			for v32, v33 := range in.Users {
				if v32 > 0 {
					out.RawByte(',')
				}
				easyjsonD7860c2dEncodeGithubComOvhCdsSdk7(out, v33)
			}
			out.RawByte(']')
		}
	}
	if len(in.Tokens) != 0 {
		...
		}
		{
			...
			for v34, v35 := range in.Tokens {
				...
				easyjsonD7860c2dEncodeGithubComOvhCdsSdk8(out, v35)
			}
			out.RawByte(']')
		}
	}
	...
	for !in.IsDelim('}') {
		...
		case "groups":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v36 Group
					easyjsonD7860c2dDecodeGithubComOvhCdsSdk5(in, &v36)
		...
		case "favorites":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v37 Favorite
					easyjsonD7860c2dDecodeGithubComOvhCdsSdk9(in, &v37)
					out.Favorites = append(out.Favorites, v37)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonD7860c2dEncodeGithubComOvhCdsSdk7(out *jwriter.Writer, in User) {
	...
	if len(in.Groups) != 0 {
		...
		}
		{
			...
			for v38, v39 := range in.Groups {
				...
				easyjsonD7860c2dEncodeGithubComOvhCdsSdk5(out, v39)
			}
			out.RawByte(']')
		}
	}
	...
	}
	{
		...
		if in.Favorites == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v40, v41 := range in.Favorites {
				if v40 > 0 {
					out.RawByte(',')
				}
				easyjsonD7860c2dEncodeGithubComOvhCdsSdk9(out, v41)
			}
			out.RawByte(']')
		}
	}
		...
		case "project_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v42 int64
					v42 = int64(in.Int64())
					out.ProjectIDs = append(out.ProjectIDs, v42)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "workflow_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v43 int64
					v43 = int64(in.Int64())
					out.WorkflowIDs = append(out.WorkflowIDs, v43)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonD7860c2dEncodeGithubComOvhCdsSdk9(out *jwriter.Writer, in Favorite) {
	...
	_ = first
	{
		...
		if in.ProjectIDs == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v44, v45 := range in.ProjectIDs {
				if v44 > 0 {
					out.RawByte(',')
				}
				out.Int64(int64(v45))
	...
	}
	{
		...
		if in.WorkflowIDs == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v46, v47 := range in.WorkflowIDs {
				if v46 > 0 {
					out.RawByte(',')
				}
				out.Int64(int64(v47))
	...
	for !in.IsDelim('}') {
		...
		case "lines":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v51 MonitoringStatusLine
					easyjsonD7860c2dDecodeGithubComOvhCdsSdk12(in, &v51)
					out.Lines = append(out.Lines, v51)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonD7860c2dEncodeGithubComOvhCdsSdk11(out *jwriter.Writer, in MonitoringStatus) {
	...
	}
	{
		...
		if in.Lines == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v52, v53 := range in.Lines {
				if v52 > 0 {
					out.RawByte(',')
				}
				easyjsonD7860c2dEncodeGithubComOvhCdsSdk12(out, v53)
			}
			out.RawByte(']')
		}
	}
	...
	for !in.IsDelim('}') {
		...
		case "step_status":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v54 StepStatus
					easyjsonD7860c2dDecodeGithubComOvhCdsSdk13(in, &v54)
					out.StepStatus = append(out.StepStatus, v54)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "warnings":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v55 PipelineBuildWarning
					easyjsonD7860c2dDecodeGithubComOvhCdsSdk15(in, &v55)
					out.Warnings = append(out.Warnings, v55)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonD7860c2dEncodeGithubComOvhCdsSdk1(out *jwriter.Writer, in ExecutedJob) {
	...
	_ = first
	{
		...
		if in.StepStatus == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v56, v57 := range in.StepStatus {
				if v56 > 0 {
					out.RawByte(',')
				}
				easyjsonD7860c2dEncodeGithubComOvhCdsSdk13(out, v57)
			}
			out.RawByte(']')
		}
	}
	...
	}
	{
		...
		if in.Warnings == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v58, v59 := range in.Warnings {
				if v58 > 0 {
					out.RawByte(',')
				}
				easyjsonD7860c2dEncodeGithubComOvhCdsSdk15(out, v59)
			}
			out.RawByte(']')
		}
	}
	...
	for !in.IsDelim('}') {
		...
		case "requirements":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v60 Requirement
					if data := in.Raw(); in.Ok() {
						in.AddError((v60).UnmarshalJSON(data))
					}
					out.Requirements = append(out.Requirements, v60)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "parameters":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v61 Parameter
					easyjsonD7860c2dDecodeGithubComOvhCdsSdk2(in, &v61)
					out.Parameters = append(out.Parameters, v61)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "actions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v62 Action
					easyjsonD7860c2dDecodeGithubComOvhCdsSdk14(in, &v62)
					out.Actions = append(out.Actions, v62)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonD7860c2dEncodeGithubComOvhCdsSdk14(out *jwriter.Writer, in Action) {
	...
	}
	{
		...
		if in.Parameters == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v65, v66 := range in.Parameters {
				if v65 > 0 {
					out.RawByte(',')
				}
				easyjsonD7860c2dEncodeGithubComOvhCdsSdk2(out, v66)
			}
			out.RawByte(']')
		}
	}
	{
		...
		if in.Actions == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v67, v68 := range in.Actions {
				if v67 > 0 {
					out.RawByte(',')
				}
				easyjsonD7860c2dEncodeGithubComOvhCdsSdk14(out, v68)
			}
			out.RawByte(']')
		}
	}
