...
type Configuration struct {
	...
	URL      string                          `toml:"url" comment:"URL of this UI service. You can expose CDS UI with sub path like https://your-domain.com/ui" default:"http://localhost:8080" json:"url"`
