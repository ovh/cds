...
ALTER TABLE workflow_run DROP CONSTRAINT fk_workflow_node_run_workflow_run;
...
ALTER TABLE workflow_run DROP CONSTRAINT fk_workflow_node_run_jogs_workflow_node_run;
...
ALTER TABLE workflow_run DROP CONSTRAINT fk_workflow_node_run_jobs_workflow_node_run;
