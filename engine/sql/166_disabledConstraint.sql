-- +migrate Up
ALTER TABLE workflow DROP CONSTRAINT fk_workflow_root_node;
ALTER TABLE workflow_node DROP CONSTRAINT fk_workflow_node_pipeline;
ALTER TABLE workflow_node DROP CONSTRAINT fk_workflow_node_workflow;

ALTER TABLE workflow_notification_source DROP CONSTRAINT fk_workflow_notification_source_node;
