...
ALTER TABLE "broadcast_read" ADD COLUMN authentified_user_id VARCHAR(36) NOT NULL;
...
ALTER TABLE "project_favorite" ADD COLUMN authentified_user_id VARCHAR(36) NOT NULL;
...
ALTER TABLE "workflow_favorite" ADD COLUMN authentified_user_id VARCHAR(36) NOT NULL;
...
ALTER TABLE "user_timeline" ADD COLUMN authentified_user_id VARCHAR(36) NOT NULL;
