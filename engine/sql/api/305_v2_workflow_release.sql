...
(
    ...
    "workflow_vcs"          VARCHAR(255) NOT NULL,
    "workflow_repository"   VARCHAR(255) NOT NULL,
...
SELECT create_unique_index('v2_workflow_version', 'idx_unq_v2_workflow_version', 'project_key,workflow_vcs,workflow_repository,workflow_name,version');
