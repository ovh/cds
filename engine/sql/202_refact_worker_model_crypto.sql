...
ALTER TABLE "worker_model" DROP COLUMN template;
ALTER TABLE "worker_model" DROP COLUMN communication;
ALTER TABLE "worker_model" DROP COLUMN run_script;
ALTER TABLE "worker_model" DROP COLUMN provision;
...
ALTER TABLE "worker_model" ADD COLUMN IF NOT EXISTS cipher_secrets BYTEA;
