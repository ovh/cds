...
//
//	mockgen -source=types.go -destination=mock_elasticsearch/esclient_mock.go ESClient
//
...
func (m *MockESClient) IndexDocWithoutType(ctx context.Context, index, id string, body any) (*opensearchapi.DocumentCreateResp, error) {
	m.ctrl.T.Helper()
...
func (mr *MockESClientMockRecorder) IndexDocWithoutType(ctx, index, id, body any) *gomock.Call {
...
func (mr *MockESClientMockRecorder) Ping(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockESClientMockRecorder) SearchDoc(ctx, index, query, sorts, from, size any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
