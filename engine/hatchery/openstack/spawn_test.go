...
func TestHatcheryOpenstack_checkSpawnLimits_MaxWorker(t *testing.T) {
	...
	err := h.checkSpawnLimits(context.TODO(), flavors.Flavor{}, sdk.WorkerStarterWorkerModel{ModelV1: &m})
...
func TestHatcheryOpenstack_checkSpawnLimits_MaxCPUs(t *testing.T) {
	...
	err = h.checkSpawnLimits(context.TODO(), h.flavors[0], sdk.WorkerStarterWorkerModel{ModelV1: &m})
	require.Error(t, err)
...
func TestHatcheryOpenstack_checkSpawnLimits_CountSmallerFlavorToKeep(t *testing.T) {
	...
	err := h.checkSpawnLimits(context.TODO(), h.flavors[1], sdk.WorkerStarterWorkerModel{ModelV1: &m3})
	...
	err = h.checkSpawnLimits(context.TODO(), h.flavors[2], sdk.WorkerStarterWorkerModel{ModelV1: &m2})
