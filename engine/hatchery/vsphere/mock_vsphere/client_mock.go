...
//
//	mockgen -source=vsphere.go -destination=mock_vsphere/client_mock.go -package mock_vsphere
//
...
func (mr *MockVSphereClientMockRecorder) CloneVirtualMachine(ctx, vm, folder, name, config any) *gomock.Call {
...
func (mr *MockVSphereClientMockRecorder) DestroyVirtualMachine(ctx, vm any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVSphereClientMockRecorder) GetVirtualMachinePowerState(ctx, vm any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVSphereClientMockRecorder) ListVirtualMachines(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVSphereClientMockRecorder) LoadDatastore(ctx, name any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVSphereClientMockRecorder) LoadFolder(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVSphereClientMockRecorder) LoadNetwork(ctx, name any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVSphereClientMockRecorder) LoadResourcePool(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVSphereClientMockRecorder) LoadVirtualMachine(ctx, name any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVSphereClientMockRecorder) LoadVirtualMachineDevices(ctx, vm any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVSphereClientMockRecorder) LoadVirtualMachineEvents(ctx, vm any, eventTypes ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, vm}, eventTypes...)
...
func (mr *MockVSphereClientMockRecorder) NewVirtualMachine(ctx, cloneSpec, ref, vmName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVSphereClientMockRecorder) ProcessManager(ctx, vm any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVSphereClientMockRecorder) RenameVirtualMachine(ctx, vm, newName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVSphereClientMockRecorder) SetupEthernetCard(ctx, card, ethernetCardName, network any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVSphereClientMockRecorder) ShutdownVirtualMachine(ctx, vm any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVSphereClientMockRecorder) StartProgramInGuest(ctx, procman, req any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVSphereClientMockRecorder) StartVirtualMachine(ctx, vm any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVSphereClientMockRecorder) WaitForVirtualMachineIP(ctx, vm, IPAddress, vmName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVSphereClientMockRecorder) WaitForVirtualMachineShutdown(ctx, vm any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
