...
$ hatchery mesos --api=https://<api.domain> --token=<token>
	...
	Run: func(cmd *cobra.Command, args []string) {
		hatchery.Create(hatcheryMesos, viper.GetString("api"), viper.GetString("token"), viper.GetInt("provision"), viper.GetInt("request-api-timeout"), viper.GetBool("insecure"))
	},
