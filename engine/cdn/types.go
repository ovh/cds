...
type Configuration struct {
	...
	NbJobWorkers     int64 `toml:"nbJobWorkers" default:"45" comment:"Number of workers that dequeue the job log queue" json:"nbJobWorkers"`
	NbServiceWorkers int64 `toml:"nbServiceWorkers" default:"5" comment:"Number of workers that dequeue the job log queue" json:"nbServiceWorkers"`
}
