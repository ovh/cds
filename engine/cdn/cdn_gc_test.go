...
func TestCleanSynchronizedItem(t *testing.T) {
	...
	iu2Redis := sdk.CDNItemUnit{UnitID: s.Units.Buffer.ID(), ItemID: item2RedisFs.ID, Type: item2RedisFs.Type}
	...
	iu4Redis := sdk.CDNItemUnit{UnitID: s.Units.Buffer.ID(), ItemID: item4Redis.ID, Type: item4Redis.Type}
	...
	iu6Redis := sdk.CDNItemUnit{UnitID: s.Units.Buffer.ID(), ItemID: item6RedisFSCDS.ID, Type: item6RedisFSCDS.Type}
