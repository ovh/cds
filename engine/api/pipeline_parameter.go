...
func (api *API) deleteParameterFromPipelineHandler() service.Handler {
	return func(ctx context.Context, w http.ResponseWriter, r *http.Request) error {
		...
		event.PublishPipelineParameterDelete(key, pipelineName, sdk.Parameter{Name: paramName}, getAuthentifiedUser(ctx))
...
func (api *API) updateParameterInPipelineHandler() service.Handler {
	return func(ctx context.Context, w http.ResponseWriter, r *http.Request) error {
		...
		event.PublishPipelineParameterUpdate(key, pipelineName, *oldParam, newParam, getAuthentifiedUser(ctx))
...
func (api *API) addParameterInPipelineHandler() service.Handler {
	return func(ctx context.Context, w http.ResponseWriter, r *http.Request) error {
		...
		event.PublishPipelineParameterAdd(key, pipelineName, newParam, getAuthentifiedUser(ctx))
