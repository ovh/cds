...
// writeNoContentMiddleware writes StatusNoContent (204) for each response with No Header Content-Type
...
func (api *API) writeNoContentPostMiddleware(ctx context.Context, w http.ResponseWriter, req *http.Request, rc *HandlerConfig) (context.Context, error) {
