...
func buildRunContext(ctx context.Context, db *gorp.DbMap, store cache.Store, wr sdk.V2WorkflowRun, vcsServer sdk.VCSProject, repo sdk.ProjectRepository, uiURL string) (*sdk.WorkflowRunContext, error) {
	...
	gitContext := sdk.GitContext{
		...
		PullRequestFromRef:     wr.RunEvent.PullRequestFromRef,
		PullRequestFromRefName: strings.TrimPrefix(strings.TrimPrefix(wr.RunEvent.PullRequestFromRef, sdk.GitRefBranchPrefix), sdk.GitRefTagPrefix),
	}
