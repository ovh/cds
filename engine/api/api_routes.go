...
func (api *API) InitRouter() {
	...
	r.Handle("/worker/model/{groupName}/{permModelName}", Scope(sdk.AccessTokenScopeWorkerModel), r.GET(api.getWorkerModelHandler), r.PUT(api.putWorkerModelHandler), r.DELETE(api.deleteWorkerModelHandler))
	r.Handle("/worker/model/{groupName}/{permModelName}/export", Scope(sdk.AccessTokenScopeWorkerModel), r.GET(api.getWorkerModelExportHandler))
	r.Handle("/worker/model/{groupName}/{permModelName}/usage", Scope(sdk.AccessTokenScopeWorkerModel), r.GET(api.getWorkerModelUsageHandler))
	...
	r.Handle("/template/{groupName}/{permTemplateSlug}", Scope(sdk.AccessTokenScopeTemplate), r.GET(api.getTemplateHandler), r.PUT(api.putTemplateHandler), r.DELETE(api.deleteTemplateHandler))
	r.Handle("/template/{groupName}/{permTemplateSlug}/pull", Scope(sdk.AccessTokenScopeTemplate), r.POST(api.postTemplatePullHandler))
	r.Handle("/template/{groupName}/{permTemplateSlug}/apply", Scope(sdk.AccessTokenScopeTemplate), r.POST(api.postTemplateApplyHandler))
	r.Handle("/template/{groupName}/{permTemplateSlug}/bulk", Scope(sdk.AccessTokenScopeTemplate), r.POST(api.postTemplateBulkHandler))
	r.Handle("/template/{groupName}/{permTemplateSlug}/bulk/{bulkID}", Scope(sdk.AccessTokenScopeTemplate), r.GET(api.getTemplateBulkHandler))
	r.Handle("/template/{groupName}/{permTemplateSlug}/instance", Scope(sdk.AccessTokenScopeTemplate), r.GET(api.getTemplateInstancesHandler))
	r.Handle("/template/{groupName}/{permTemplateSlug}/instance/{instanceID}", Scope(sdk.AccessTokenScopeTemplate), r.DELETE(api.deleteTemplateInstanceHandler))
	r.Handle("/template/{groupName}/{permTemplateSlug}/audit", Scope(sdk.AccessTokenScopeTemplate), r.GET(api.getTemplateAuditsHandler))
	r.Handle("/template/{groupName}/{permTemplateSlug}/usage", Scope(sdk.AccessTokenScopeTemplate), r.GET(api.getTemplateUsageHandler))
