...
func (api *API) InitRouter() {
	...
	r.Handle("/v2/project/{projectKey}/vcs/{vcsIdentifier}/repository/{repositoryIdentifier}/workflow/{workflow}/run/{runNumber}/rerun", nil, r.PUTv2(api.putWorkflowRunV2Handler))
