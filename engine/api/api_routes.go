...
func (api *API) InitRouter() {
	...
	r.Handle("/action/{groupName}/{permActionName}", Scope(sdk.AccessTokenScopeAction), r.GET(api.getActionHandler), r.PUT(api.putActionHandler), r.DELETE(api.deleteActionHandler))
	r.Handle("/action/{groupName}/{permActionName}/usage", Scope(sdk.AccessTokenScopeAction), r.GET(api.getActionUsageHandler))
	r.Handle("/action/{groupName}/{permActionName}/export", Scope(sdk.AccessTokenScopeAction), r.GET(api.getActionExportHandler))
	r.Handle("/action/{groupName}/{permActionName}/audit", Scope(sdk.AccessTokenScopeAction), r.GET(api.getActionAuditHandler))
	r.Handle("/action/{groupName}/{permActionName}/audit/{auditID}/rollback", Scope(sdk.AccessTokenScopeAction), r.POST(api.postActionAuditRollbackHandler))
	...
	// Worker models
	r.Handle("/worker/model", Scope(sdk.AccessTokenScopeWorkerModel), r.POST(api.addWorkerModelHandler), r.GET(api.getWorkerModelsHandler))
	...
	r.Handle("/worker/model/{modelID}/export", Scope(sdk.AccessTokenScopeWorkerModel), r.GET(api.getWorkerModelExportHandler))
	r.Handle("/worker/model/{modelID}/usage", Scope(sdk.AccessTokenScopeWorkerModel), r.GET(api.getWorkerModelUsageHandler))
	...
	r.Handle("/template/{id}", Scope(sdk.AccessTokenScopeTemplate), r.GET(api.getTemplateHandler))
	r.Handle("/template/{groupName}/{templateSlug}", Scope(sdk.AccessTokenScopeTemplate), r.GET(api.getTemplateHandler), r.PUT(api.putTemplateHandler), r.DELETE(api.deleteTemplateHandler))
	r.Handle("/template/{groupName}/{templateSlug}/pull", Scope(sdk.AccessTokenScopeTemplate), r.POST(api.postTemplatePullHandler))
	r.Handle("/template/{groupName}/{templateSlug}/apply", Scope(sdk.AccessTokenScopeTemplate), r.POST(api.postTemplateApplyHandler))
	r.Handle("/template/{groupName}/{templateSlug}/bulk", Scope(sdk.AccessTokenScopeTemplate), r.POST(api.postTemplateBulkHandler))
	r.Handle("/template/{groupName}/{templateSlug}/bulk/{bulkID}", Scope(sdk.AccessTokenScopeTemplate), r.GET(api.getTemplateBulkHandler))
	r.Handle("/template/{groupName}/{templateSlug}/instance", Scope(sdk.AccessTokenScopeTemplate), r.GET(api.getTemplateInstancesHandler))
	r.Handle("/template/{groupName}/{templateSlug}/instance/{instanceID}", Scope(sdk.AccessTokenScopeTemplate), r.DELETE(api.deleteTemplateInstanceHandler))
	r.Handle("/template/{groupName}/{templateSlug}/audit", Scope(sdk.AccessTokenScopeTemplate), r.GET(api.getTemplateAuditsHandler))
	r.Handle("/template/{groupName}/{templateSlug}/usage", Scope(sdk.AccessTokenScopeTemplate), r.GET(api.getTemplateUsageHandler))
	r.Handle("/project/{key}/workflow/{permWorkflowName}/templateInstance", Scope(sdk.AccessTokenScopeProject), r.GET(api.getTemplateInstanceHandler))
