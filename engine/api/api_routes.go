...
func (api *API) InitRouter() {
	...
	r.Handle("/admin/user/{permUsername}/auth/consumer", Scope(sdk.AuthConsumerScopeAdmin), r.POST(api.postAdminConsumerByUserHandler, service.OverrideAuth(api.authAdminMiddleware)))
	...
	// Search
	r.Handle("/search", Scope(sdk.AuthConsumerScopeProject), r.GETv2(api.getSearchHandler))
	r.Handle("/search/filter", Scope(sdk.AuthConsumerScopeProject), r.GETv2(api.getSearchFiltersHandler))
	...
	r.Handle("/v2/hatchery/{hatcheryIdentifier}/regen", Scope(sdk.AuthConsumerScopeHatchery), r.POSTv2(api.postHatcheryRegenTokenHandler))
	...
	r.Handle("/v2/hooks/repositories/{vcsServer}/{repositoryName}", Scope(sdk.AuthConsumerScopeHooks), r.GETv2(api.getHooksRepositoriesHandler))
	r.Handle("/v2/hooks/{projectKey}/vcs/{vcsServer}/repository/{repositoryName}/insight/{commit}/{insightKey}", Scope(sdk.AuthConsumerScopeHooks), r.POSTv2(api.postInsightReportHandler))
	r.Handle("/v2/hooks/project/{projectKey}/vcs/{vcsIdentifier}/repository/{repositoryIdentifier}/workflow/{workflow}/run", Scope(sdk.AuthConsumerScopeHooks), r.POSTv2(api.postWorkflowRunFromHookV2Handler))

	r.Handle("/v2/jsonschema/{type}", Scope(sdk.AuthConsumerScopeProject), r.GETv2(api.getJsonSchemaHandler))

	r.Handle("/v2/organization", Scope(sdk.AuthConsumerScopeAdmin), r.POSTv2(api.postOrganizationHandler), r.GETv2(api.getOrganizationsHandler))
	r.Handle("/v2/organization/{organizationIdentifier}", Scope(sdk.AuthConsumerScopeAdmin), r.GETv2(api.getOrganizationHandler), r.DELETEv2(api.deleteOrganizationHandler))

	r.Handle("/v2/rbac", Scope(sdk.AuthConsumerScopeAdmin), r.GETv2(api.getPermissionsHandler))
	r.Handle("/v2/rbac/import", Scope(sdk.AuthConsumerScopeAdmin), r.POSTv2(api.postImportRBACHandler))
	r.Handle("/v2/rbac/{rbacIdentifier}", Scope(sdk.AuthConsumerScopeAdmin), r.GETv2(api.getRBACHandler), r.DELETEv2(api.deleteRBACHandler))
	r.Handle("/v2/rbac/access/project/session/check", ScopeNone(), r.POSTv2(api.getCheckSessionProjectAccessHandler))

	r.Handle("/v2/region", Scope(sdk.AuthConsumerScopeAdmin), r.POSTv2(api.postRegionHandler), r.GETv2(api.getRegionsHandler))
	r.Handle("/v2/region/{regionIdentifier}", Scope(sdk.AuthConsumerScopeAdmin), r.GETv2(api.getRegionHandler), r.DELETEv2(api.deleteRegionHandler))

	r.Handle("/v2/migrate/project/{projectKey}/variableset/item", Scope(sdk.AuthConsumerScopeProject), r.POSTv2(api.postMigrateProjectVariableHandler))
	r.Handle("/v2/migrate/project/{projectKey}/variableset/application", Scope(sdk.AuthConsumerScopeProject), r.POSTv2(api.postMigrateApplicationVariableToVariableSetHandler))
	r.Handle("/v2/migrate/project/{projectKey}/variableset/application/integration", Scope(sdk.AuthConsumerScopeProject), r.POSTv2(api.postMigrateApplicationIntegrationVariableToVariableSetHandler))
	r.Handle("/v2/migrate/project/{projectKey}/variableset/environment", Scope(sdk.AuthConsumerScopeProject), r.POSTv2(api.postMigrateEnvironmentVariableToVariableSetHandler))
	r.Handle("/v2/migrate/project/{projectKey}/variableset/ascode", Scope(sdk.AuthConsumerScopeProject), r.POSTv2(api.postMigrateAsCodeVariableToVariableSetItemHandler))
	r.Handle("/v2/project", Scope(sdk.AuthConsumerScopeProject), r.GETv2(api.getProjectsV2Handler))
	r.Handle("/v2/project/{projectKey}", Scope(sdk.AuthConsumerScopeProject), r.GETv2(api.getProjectV2Handler), r.PUTv2(api.updateProjectV2Handler), r.DELETEv2(api.deleteProjectV2Handler))
	...
	r.Handle("/v2/project/{projectKey}/integrations", Scope(sdk.AuthConsumerScopeProject), r.GETv2(api.getProjectV2IntegrationsHandler), r.POSTv2(api.postProjectV2IntegrationHandler))
	r.Handle("/v2/project/{projectKey}/integrations/{integrationName}", Scope(sdk.AuthConsumerScopeProject), r.GETv2(api.getProjectV2IntegrationHandler), r.PUTv2(api.putProjectV2IntegrationHandler), r.DELETEv2(api.deleteProjectV2IntegrationHandler))
	r.Handle("/v2/project/{projectKey}/integrations/{integrationName}/workerhooks", Scope(sdk.AuthConsumerScopeProject), r.GETv2(api.getV2ProjectIntegrationWorkerHookHandler), r.POSTv2(api.postV2ProjectIntegrationWorkerHookHandler))
	r.Handle("/v2/project/{projectKey}/keys", Scope(sdk.AuthConsumerScopeProject), r.GETv2(api.getKeysInProjectV2Handler), r.POSTv2(api.addKeyInProjectV2Handler))
	r.Handle("/v2/project/{projectKey}/keys/{name}", Scope(sdk.AuthConsumerScopeProject), r.DELETEv2(api.deleteKeyInProjectV2Handler))
	r.Handle("/v2/project/{projectKey}/keys/{name}/disable", Scope(sdk.AuthConsumerScopeProject), r.POSTv2(api.postDisableKeyInProjectV2Handler))
	r.Handle("/v2/project/{projectKey}/keys/{name}/enable", Scope(sdk.AuthConsumerScopeProject), r.POSTv2(api.postEnableKeyInProjectV2Handler))

	r.Handle("/v2/project/{projectKey}/type/{type}/access", Scope(sdk.AuthConsumerScopeService), r.GETv2(api.getProjectV2AccessHandler))

	r.Handle("/v2/project/{projectKey}/notification", Scope(sdk.AuthConsumerScopeProject), r.GETv2(api.getProjectNotifsHandler), r.POSTv2(api.postProjectNotificationHandler))
	r.Handle("/v2/project/{projectKey}/notification/{notification}", Scope(sdk.AuthConsumerScopeProject), r.GETv2(api.getProjectNotificationHandler), r.PUTv2(api.putProjectNotificationHandler), r.DELETEv2(api.deleteProjectNotificationHandler))

	r.Handle("/v2/project/{projectKey}/repositories_manager/{name}/repos", Scope(sdk.AuthConsumerScopeProject), r.GETv2(api.getReposFromRepositoriesManagerV2Handler))

	r.Handle("/v2/project/{projectKey}/variableset", Scope(sdk.AuthConsumerScopeProject), r.GETv2(api.getProjectVariableSetsHandler), r.POSTv2(api.postProjectVariableSetHandler))
	r.Handle("/v2/project/{projectKey}/variableset/{variableSetName}", Scope(sdk.AuthConsumerScopeProject), r.GETv2(api.getProjectVariableSetHandler), r.DELETEv2(api.deleteProjectVariableSetHandler))
	r.Handle("/v2/project/{projectKey}/variableset/{variableSetName}/item", Scope(sdk.AuthConsumerScopeProject), r.POSTv2(api.postProjectVariableSetItemHandler))
	r.Handle("/v2/project/{projectKey}/variableset/{variableSetName}/item/{itemName}", Scope(sdk.AuthConsumerScopeProject), r.GETv2(api.getProjectVariableSetItemHandler), r.PUTv2(api.putProjectVariableSetItemHandler), r.DELETEv2(api.deleteProjectVariableSetItemHandler))
	r.Handle("/v2/project/{projectKey}/vcs", Scope(sdk.AuthConsumerScopeProject), r.POSTv2(api.postVCSProjectHandler), r.GETv2(api.getVCSProjectAllHandler))
	r.Handle("/v2/project/{projectKey}/vcs/{vcsIdentifier}", Scope(sdk.AuthConsumerScopeProject), r.PUTv2(api.putVCSProjectHandler), r.DELETEv2(api.deleteVCSProjectHandler), r.GETv2(api.getVCSProjectHandler))
	r.Handle("/v2/project/{projectKey}/vcs/{vcsIdentifier}/repository", Scope(sdk.AuthConsumerScopeProject), r.POSTv2(api.postProjectRepositoryHandler), r.GETv2(api.getVCSProjectRepositoryAllHandler))
	r.Handle("/v2/project/{projectKey}/vcs/{vcsIdentifier}/repository/{repositoryIdentifier}", Scope(sdk.AuthConsumerScopeProject), r.GETv2(api.getProjectRepositoryHandler), r.DELETEv2(api.deleteProjectRepositoryHandler))
	r.Handle("/v2/project/{projectKey}/vcs/{vcsIdentifier}/repository/{repositoryIdentifier}/action/{actionName}", Scope(sdk.AuthConsumerScopeProject), r.GETv2(api.getActionV2Handler))
	r.Handle("/v2/project/{projectKey}/vcs/{vcsIdentifier}/repository/{repositoryIdentifier}/analysis", Scope(sdk.AuthConsumerScopeProject), r.GETv2(api.getProjectRepositoryAnalysesHandler), r.POSTv2(api.postRepositoryAnalysisHandler))
	r.Handle("/v2/project/{projectKey}/vcs/{vcsIdentifier}/repository/{repositoryIdentifier}/analysis/{analysisID}", Scope(sdk.AuthConsumerScopeProject), r.GETv2(api.getProjectRepositoryAnalysisHandler))
	r.Handle("/v2/project/{projectKey}/vcs/{vcsIdentifier}/repository/{repositoryIdentifier}/branches", Scope(sdk.AuthConsumerScopeProject), r.GETv2(api.getProjectRepositoryBranchesHandler))
	r.Handle("/v2/project/{projectKey}/vcs/{vcsIdentifier}/repository/{repositoryIdentifier}/tags", Scope(sdk.AuthConsumerScopeProject), r.GETv2(api.getProjectRepositoryTagsHandler))
	r.Handle("/v2/project/{projectKey}/vcs/{vcsIdentifier}/repository/{repositoryIdentifier}/entities", Scope(sdk.AuthConsumerScopeProject), r.GETv2(api.getProjectEntitiesHandler))
	r.Handle("/v2/project/{projectKey}/vcs/{vcsIdentifier}/repository/{repositoryIdentifier}/entities/{entityType}/{entityName}", Scope(sdk.AuthConsumerScopeProject), r.GETv2(api.getProjectEntityHandler))
	r.Handle("/v2/project/{projectKey}/vcs/{vcsIdentifier}/repository/{repositoryIdentifier}/events", Scope(sdk.AuthConsumerScopeProject), r.GETv2(api.getProjectRepositoryEventsHandler))
	r.Handle("/v2/project/{projectKey}/vcs/{vcsIdentifier}/repository/{repositoryIdentifier}/events/{eventID}", Scope(sdk.AuthConsumerScopeProject), r.GETv2(api.getProjectRepositoryEventHandler))
	r.Handle("/v2/project/{projectKey}/vcs/{vcsIdentifier}/repository/{repositoryIdentifier}/workermodel", Scope(sdk.AuthConsumerScopeProject), r.GETv2(api.getWorkerModelsV2Handler))
	r.Handle("/v2/project/{projectKey}/vcs/{vcsIdentifier}/repository/{repositoryIdentifier}/workermodel/{workerModelName}", Scope(sdk.AuthConsumerScopeProject), r.GETv2(api.getWorkerModelV2Handler))
	r.Handle("/v2/project/{projectKey}/vcs/{vcsIdentifier}/repository/{repositoryIdentifier}/workflow/{workflow}/run", Scope(sdk.AuthConsumerScopeProject), r.POSTv2(api.postWorkflowRunV2Handler))
	r.Handle("/v2/project/{projectKey}/vcs/{vcsIdentifier}/repository/{repositoryIdentifier}/workflow/{workflow}/version", Scope(sdk.AuthConsumerScopeProject), r.GETv2(api.getWorkflowVersionsHandler))
	r.Handle("/v2/project/{projectKey}/vcs/{vcsIdentifier}/repository/{repositoryIdentifier}/workflow/{workflow}/version/{version}", Scope(sdk.AuthConsumerScopeProject), r.GETv2(api.getWorkflowVersionHandler), r.DELETEv2(api.deleteWorkflowVersionHandler))
	r.Handle("/v2/project/{projectKey}/run", Scope(sdk.AuthConsumerScopeRun), r.GETv2(api.getWorkflowRunsSearchV2Handler))
	r.Handle("/v2/project/{projectKey}/run/filter", Scope(sdk.AuthConsumerScopeRun), r.GETv2(api.getWorkflowRunsFiltersV2Handler))
	...
	r.Handle("/v2/project/{projectKey}/run/{workflowRunID}/infos", Scope(sdk.AuthConsumerScopeRun), r.GETv2(api.getWorkflowRunInfoV2Handler))
	r.Handle("/v2/project/{projectKey}/run/{workflowRunID}/stop", Scope(sdk.AuthConsumerScopeRun), r.POSTv2(api.postStopWorkflowRunHandler))
	r.Handle("/v2/project/{projectKey}/run/{workflowRunID}/job", Scope(sdk.AuthConsumerScopeRun), r.GETv2(api.getWorkflowRunJobsV2Handler), r.POSTv2(api.postStartJobWorkflowRunHandler))
	r.Handle("/v2/project/{projectKey}/run/{workflowRunID}/result", Scope(sdk.AuthConsumerScopeRun), r.GETv2(api.getWorkflowRunResultsV2Handler))
	r.Handle("/v2/project/{projectKey}/run/{workflowRunID}/job/{jobRunID}", Scope(sdk.AuthConsumerScopeRun), r.GETv2(api.getWorkflowRunJobHandler))
	r.Handle("/v2/project/{projectKey}/run/{workflowRunID}/job/{jobRunID}/retry", Scope(sdk.AuthConsumerScopeRun), r.GETv2(api.getWorkflowRunJobRetryHandler))
	r.Handle("/v2/project/{projectKey}/run/{workflowRunID}/job/{jobRunID}/infos", Scope(sdk.AuthConsumerScopeRun), r.GETv2(api.getWorkflowRunJobInfosHandler))
	r.Handle("/v2/project/{projectKey}/run/{workflowRunID}/job/{jobIdentifier}/run", Scope(sdk.AuthConsumerScopeRun), r.POSTv2(api.postRunJobHandler))
	r.Handle("/v2/project/{projectKey}/run/{workflowRunID}/job/{jobIdentifier}/stop", Scope(sdk.AuthConsumerScopeRun), r.POSTv2(api.postStopJobHandler))
	r.Handle("/v2/project/{projectKey}/run/{workflowRunID}/job/{jobRunID}/logs/links", Scope(sdk.AuthConsumerScopeRun), r.GETv2(api.getWorkflowRunJobLogsLinksV2Handler))
	r.Handle("/v2/project/{projectKey}/run/{workflowRunID}/job/{jobRunID}/service/{serviceName}/link", Scope(sdk.AuthConsumerScopeRun), r.GETv2(api.getWorkflowRunJobServiceLogsLinkV2Handler))
	r.Handle("/v2/run", Scope(sdk.AuthConsumerScopeRun), r.GETv2(api.getWorkflowRunsSearchAllProjectV2Handler))

	r.Handle("/v2/template/workflow/generate", Scope(sdk.AuthConsumerScopeProject), r.POSTv2(api.postGenerateWorkflowFromTemplateHandler))

	r.Handle("/v2/plugin", ScopeNone(), r.POSTv2(api.postImportPluginHandler))
	r.Handle("/v2/plugin/{name}", ScopeNone(), r.GETv2(api.getPluginHandler))

	r.Handle("/v2/queue/{regionName}/job/{runJobID}", Scope(sdk.AuthConsumerScopeRunExecution), r.GETv2(api.getJobRunQueueInfoHandler))
	r.Handle("/v2/queue/{regionName}/job/{runJobID}/info", Scope(sdk.AuthConsumerScopeRunExecution), r.POSTv2(api.postJobRunInfoHandler))
	r.Handle("/v2/queue/{regionName}/job/{runJobID}/key/{keyName}", Scope(sdk.AuthConsumerScopeRunExecution), r.GETv2(api.getJobRunProjectV2KeyHandler))
	r.Handle("/v2/queue/{regionName}/job/{runJobID}/runinfo", Scope(sdk.AuthConsumerScopeRunExecution), r.POSTv2(api.postRunInfoHandler))
	...
	r.Handle("/v2/queue/{regionName}/job/{runJobID}/runresult", Scope(sdk.AuthConsumerScopeRunExecution), r.GETv2(api.getJobRunResultsHandler), r.POSTv2(api.postJobRunResultHandler), r.PUTv2(api.putJobRunResultHandler))
	r.Handle("/v2/queue/{regionName}/job/{runJobID}/runresult/synchronize", Scope(sdk.AuthConsumerScopeRunExecution), r.PUTv2(api.putJobRunResultSynchronizeHandler))
	r.Handle("/v2/queue/{regionName}/job/{runJobID}/runresult/{runResultID}", Scope(sdk.AuthConsumerScopeRunExecution), r.GETv2(api.getJobRunResultHandler))
	r.Handle("/v2/queue/{regionName}/job/{runJobID}/cache/{cacheKey}/link", Scope(sdk.AuthConsumerScopeRunExecution), r.GETv2(api.getCacheLinkHandler))

	r.Handle("/v2/queue/{regionName}", Scope(sdk.AuthConsumerScopeRunExecution), r.GETv2(api.getJobsQueuedRegionalizedHandler))
	r.Handle("/v2/queue", Scope(sdk.AuthConsumerScopeRunExecution), r.GETv2(api.getJobsQueuedHandler))

	r.Handle("/v2/worker", Scope(sdk.AuthConsumerScopeHatchery), r.GETv2(api.getWorkersV2Handler))
