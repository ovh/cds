...
func (api *API) InitRouter() {
	...
	r.Handle("/project/{key}/workflows/{permWorkflowName}/ascode/migrate", Scope(sdk.AuthConsumerScopeProject), r.POST(api.postMigrateWorkflowAsCodeHandler, EnableTracing()))
