...
func (api *API) InitRouter() {
	...
	r.Handle("/project/{permProjectKey}/integrations/{integrationName}/workerhooks", Scope(sdk.AuthConsumerScopeProject), r.GET(api.getProjectIntegrationWorkerHooksHandler), r.POST(api.postProjectIntegrationWorkerHooksHandler))
	r.Handle("/project/{permProjectKey}/integrations/{integrationName}/workerhooks/{id}", Scope(sdk.AuthConsumerScopeProject), r.GET(api.getProjectIntegrationWorkerHookHandler), r.PUT(api.putProjectIntegrationWorkerHookHandler))
