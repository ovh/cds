...
func (api *API) InitRouter() {
	...
	r.ServeAbsoluteFile("/download/worker/x86_64", path.Join(api.Config.Directories.Download, "cds-worker-linux-i386"), "worker")
	...
	r.ServeAbsoluteFile("/download/cds-worker-linux-i386", path.Join(api.Config.Directories.Download, "cds-worker-linux-i386"), "cds-worker-linux-i386")
