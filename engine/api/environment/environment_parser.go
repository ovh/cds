...
func ParseAndImport(db gorp.SqlExecutor, proj *sdk.Project, eenv *exportentities.Environment, opts ImportOptions, decryptFunc keys.DecryptFunc, u *sdk.AuthentifiedUser) (*sdk.Environment, []sdk.Message, error) {
