...
func Test_WorkflowAsCodeWithDefaultHook_ShouldGive_TheSameRepoWebHook(t *testing.T) {
	...
	// We check that all the as-code operation is successful and create the right hook
...
func Test_WorkflowAsCodeWithJustAcheduler_ShouldGive_ARepoWebHookAndTheScheduler_ThenWeUpdateIt_ThenWeDeleteIt(t *testing.T) {
	// 1. We create a new workflow from a repository in which there is a .cds directory
	// We check that all the as-code operation is successful and create the right hooks
...
version: v1.0`),
  ...
  "git.tag": ""
	...
	// ======================================================================================
	// 2. Then we will trigger a run of the workflow which should trigger an as-code operation
	uri = api.Router.GetRoute("POST", api.postWorkflowRunHandler, map[string]string{
		"key":                      proj.Key,
		"permWorkflowNameAdvanced": wk.Name,
	})
  ...
  "git.tag": ""
	...
	// ===========================================================================================================
	// 3. Then we will trigger a run of the workflow which should trigger an as-code operation with a hook deletion
	uri = api.Router.GetRoute("POST", api.postWorkflowRunHandler, map[string]string{
		"key":                      proj.Key,
		"permWorkflowNameAdvanced": wk.Name,
	})
