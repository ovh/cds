...
func publishPipelineEvent(payload interface{}, key string, pipName string, u *sdk.AuthentifiedUser) {
	event := sdk.Event{
		Timestamp:    time.Now(),
		Hostname:     hostname,
		CDSName:      cdsname,
...
func PublishPipelineAdd(key string, pip sdk.Pipeline, u *sdk.AuthentifiedUser) {
...
func PublishPipelineUpdate(key string, newName string, oldName string, u *sdk.AuthentifiedUser) {
...
func PublishPipelineDelete(key string, pip sdk.Pipeline, u *sdk.AuthentifiedUser) {
	e := sdk.EventPipelineDelete{}
	publishPipelineEvent(e, key, pip.Name, u)
}

// PublishPipelineParameterAdd publishes an event on adding a pipeline parameter
func PublishPipelineParameterAdd(key string, pipName string, p sdk.Parameter, u *sdk.AuthentifiedUser) {
...
func PublishPipelineParameterUpdate(key string, pipName string, oldP sdk.Parameter, p sdk.Parameter, u *sdk.AuthentifiedUser) {
...
func PublishPipelineParameterDelete(key string, pipName string, p sdk.Parameter, u *sdk.AuthentifiedUser) {
...
func PublishPipelineStageAdd(key string, pipName string, s sdk.Stage, u *sdk.AuthentifiedUser) {
...
func PublishPipelineStageMove(key string, pipName string, s sdk.Stage, oldBuildOrder int, u *sdk.AuthentifiedUser) {
...
func PublishPipelineStageUpdate(key string, pipName string, oldStage sdk.Stage, newStage sdk.Stage, u *sdk.AuthentifiedUser) {
...
func PublishPipelineStageDelete(key string, pipName string, s sdk.Stage, u *sdk.AuthentifiedUser) {
...
func PublishPipelineJobAdd(key string, pipName string, s sdk.Stage, j sdk.Job, u *sdk.AuthentifiedUser) {
...
func PublishPipelineJobUpdate(key string, pipName string, s sdk.Stage, oldJob sdk.Job, newJob sdk.Job, u *sdk.AuthentifiedUser) {
...
func PublishPipelineJobDelete(key string, pipName string, s sdk.Stage, j sdk.Job, u *sdk.AuthentifiedUser) {
