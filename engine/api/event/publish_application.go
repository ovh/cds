...
func publishApplicationEvent(payload interface{}, key, appName string, u sdk.Identifiable) {
	event := sdk.Event{
		Timestamp:       time.Now(),
		Hostname:        hostname,
		CDSName:         cdsname,
...
func PublishAddApplication(projKey string, app sdk.Application, u sdk.Identifiable) {
...
func PublishUpdateApplication(projKey string, app sdk.Application, oldApp sdk.Application, u sdk.Identifiable) {
...
func PublishDeleteApplication(projKey string, app sdk.Application, u sdk.Identifiable) {
	e := sdk.EventApplicationDelete{}
	publishApplicationEvent(e, projKey, app.Name, u)
}

// PublishAddVariableApplication publishes an event when adding a new variable
func PublishAddVariableApplication(projKey string, app sdk.Application, v sdk.Variable, u sdk.Identifiable) {
...
func PublishUpdateVariableApplication(projKey string, app sdk.Application, v sdk.Variable, vOld sdk.Variable, u sdk.Identifiable) {
...
func PublishDeleteVariableApplication(projKey string, app sdk.Application, v sdk.Variable, u sdk.Identifiable) {
...
func PublishApplicationKeyAdd(projKey string, app sdk.Application, k sdk.ApplicationKey, u sdk.Identifiable) {
...
func PublishApplicationKeyDelete(projKey string, app sdk.Application, k sdk.ApplicationKey, u sdk.Identifiable) {
...
func PublishApplicationRepositoryAdd(projKey string, app sdk.Application, u sdk.Identifiable) {
...
func PublishApplicationRepositoryDelete(projKey string, appName string, vcsServer string, repository string, u sdk.Identifiable) {
...
func PublishApplicationVulnerabilityUpdate(projKey string, appName string, oldV sdk.Vulnerability, newV sdk.Vulnerability, u sdk.Identifiable) {
