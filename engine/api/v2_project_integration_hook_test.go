...
func TestAPI_post_getV2ProjectIntegrationWorkerHookHandler(t *testing.T) {
	...
	uri := router.GetRouteV2("POST", api.postV2ProjectIntegrationWorkerHookHandler, vars)
	...
	uri = router.GetRouteV2("GET", api.getV2ProjectIntegrationWorkerHookHandler, vars)
