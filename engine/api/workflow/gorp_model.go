...
// JobRunInfo is a gorp wrapper around sdk.WorkflowNodeJobRunInfo
type JobRunInfo sdk.WorkflowNodeJobRunInfo
...
func init() {
	...
	gorpmapping.Register(gorpmapping.New(JobRunInfo{}, "workflow_node_run_job_info", true, "id"))
