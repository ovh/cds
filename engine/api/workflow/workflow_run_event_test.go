...
func TestResyncCommitStatusNotifDisabled(t *testing.T) {
	...
	servicesClients.EXPECT().
		DoJSONRequest(gomock.Any(), "GET", "/vcs/github/repos/foo/myrepo/commits/6c3efde/statuses",
...
func TestResyncCommitStatusSetStatus(t *testing.T) {
	...
	servicesClients.EXPECT().
		DoJSONRequest(gomock.Any(), "GET", "/vcs/github/repos/foo/myrepo/commits/6c3efde/statuses", gomock.Any(), gomock.Any(), gomock.Any()).
...
func TestResyncCommitStatusCommentPRNotTerminated(t *testing.T) {
	...
	servicesClients.EXPECT().
		DoJSONRequest(gomock.Any(), "GET", "/vcs/github",
...
func TestResyncCommitStatusCommitCache(t *testing.T) {
	...
	wr := &sdk.WorkflowRun{
		...
		Workflow: sdk.Workflow{
			WorkflowData: sdk.WorkflowData{Node: sdk.Node{
				ID: 1,
				Context: &sdk.NodeContext{
					ApplicationID: app.ID,
				},
	...
	servicesClients.EXPECT().
		DoJSONRequest(gomock.Any(), "POST", "/vcs/github/repos/foo/myrepo/pullrequests/comments",
			gomock.Any(), gomock.Any(), gomock.Any()).
		DoAndReturn(func(ctx context.Context, method, path string, in interface{}, out interface{}, _ interface{}) (
