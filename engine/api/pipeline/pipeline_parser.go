...
func ParseAndImport(db gorp.SqlExecutor, cache cache.Store, proj *sdk.Project, epip exportentities.Pipeliner, u *sdk.AuthentifiedUser, opts ImportOptions) (*sdk.Pipeline, []sdk.Message, error) {
