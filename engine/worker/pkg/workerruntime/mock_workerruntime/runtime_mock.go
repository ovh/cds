...
// Source: engine/worker/pkg/workerruntime/types.go
//
// Generated by this command:
//
//	mockgen -source=engine/worker/pkg/workerruntime/types.go -destination=engine/worker/pkg/workerruntime/mock_workerruntime/runtime_mock.go
//
...
func (mr *MockRuntimeMockRecorder) AddStepOutput(ctx, outputName, outputValue any) *gomock.Call {
...
func (m *MockRuntime) Blur(arg0 any) error {
	m.ctrl.T.Helper()
...
func (mr *MockRuntimeMockRecorder) Blur(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRuntimeMockRecorder) FeatureEnabled(featureName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRuntimeMockRecorder) GetActionPlugin(pluginName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// GetCheckedPluginBinary mocks base method.
func (m *MockRuntime) GetCheckedPluginBinary(pluginName, os, arch string) *sdk.GRPCPluginBinary {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetCheckedPluginBinary", pluginName, os, arch)
	ret0, _ := ret[0].(*sdk.GRPCPluginBinary)
	return ret0
}

// GetCheckedPluginBinary indicates an expected call of GetCheckedPluginBinary.
func (mr *MockRuntimeMockRecorder) GetCheckedPluginBinary(pluginName, os, arch any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCheckedPluginBinary", reflect.TypeOf((*MockRuntime)(nil).GetCheckedPluginBinary), pluginName, os, arch)
}
...
func (mr *MockRuntimeMockRecorder) GetIntegrationPlugin(pluginType any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRuntimeMockRecorder) InstallKey(key any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRuntimeMockRecorder) InstallKeyTo(key, destinationPath any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRuntimeMockRecorder) PluginGet(pluginName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRuntimeMockRecorder) PluginGetBinary(name, os, arch, w any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRuntimeMockRecorder) ProcessJob(job any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRuntimeMockRecorder) Register(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRuntimeMockRecorder) RunResultSignature(fileName, perm, t any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRuntimeMockRecorder) SendLog(ctx, level, format any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRuntimeMockRecorder) SetActionPlugin(p any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetActionPlugin", reflect.TypeOf((*MockRuntime)(nil).SetActionPlugin), p)
}

// SetCheckedPluginBinary mocks base method.
func (m *MockRuntime) SetCheckedPluginBinary(b *sdk.GRPCPluginBinary) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SetCheckedPluginBinary", b)
}

// SetCheckedPluginBinary indicates an expected call of SetCheckedPluginBinary.
func (mr *MockRuntimeMockRecorder) SetCheckedPluginBinary(b any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetCheckedPluginBinary", reflect.TypeOf((*MockRuntime)(nil).SetCheckedPluginBinary), b)
}
...
func (mr *MockRuntimeMockRecorder) Take(ctx, job any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRuntimeMockRecorder) Unregister(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRuntimeMockRecorder) V2AddRunResult(ctx, req any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRuntimeMockRecorder) V2GetCacheLink(ctx, cacheKey any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRuntimeMockRecorder) V2GetCacheSignature(ctx, cacheKey any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRuntimeMockRecorder) V2GetJobContext(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRuntimeMockRecorder) V2GetJobRun(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRuntimeMockRecorder) V2GetProjectKey(ctx, keyName, clear any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRuntimeMockRecorder) V2GetRunResult(ctx, filter any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// V2RunResultsSynchronize mocks base method.
func (m *MockRuntime) V2RunResultsSynchronize(ctx context.Context) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "V2RunResultsSynchronize", ctx)
	ret0, _ := ret[0].(error)
	return ret0
}

// V2RunResultsSynchronize indicates an expected call of V2RunResultsSynchronize.
func (mr *MockRuntimeMockRecorder) V2RunResultsSynchronize(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "V2RunResultsSynchronize", reflect.TypeOf((*MockRuntime)(nil).V2RunResultsSynchronize), ctx)
}
...
func (mr *MockRuntimeMockRecorder) V2UpdateRunResult(ctx, req any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRuntimeMockRecorder) WorkerCacheSignature(tag any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
